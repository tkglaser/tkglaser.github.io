...
* Start to re-implement the application using several new concepts in
  a side-by-side way, so the improvements can be seen immediately. It is not just a like-for-like, many new features were implemented along the way.
...
Tools/Languages: **C#**, **ASP MVC**, **.NET Core 1.1**, **AngularJS** (1.x) **Angular** (2.x), **jQuery**, **ASP WebApi**, **WebForms**, **Visual Studio 2015**, **MS SQL Server**
...
* Completed or am working on a number of small to medium projects including
  new features and architectural enhancements to improve resilience.
* For these projects, I have created the functional specification and
